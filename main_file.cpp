	...
	if (action == GLFW_PRESS) {
		if (key == GLFW_KEY_LEFT) {
			...
			if (granica_j(klocki[spadajacyKlocek]) == 0) {
				klocki[spadajacyKlocek].pos_x[0] += 1.0f;
			}
		...
		if (key == GLFW_KEY_UP) {
			if (granica_i(klocki[spadajacyKlocek]) == 0) {
				klocki[spadajacyKlocek].pos_z[0] += 1.0f;
			}
...
void keyCallback(GLFWwindow* window, int key,
	...
	if (action == GLFW_PRESS) {
		if (key == GLFW_KEY_LEFT) klocki[spadajacyKlocek].angle -= PI / 2;

		if (key == GLFW_KEY_RIGHT) klocki[spadajacyKlocek].angle += PI / 2;

		if (key == GLFW_KEY_UP) klocki[spadajacyKlocek].angle_z += PI / 2;

		if (key == GLFW_KEY_DOWN) klocki[spadajacyKlocek].angle_z -= PI / 2;
